...
from utils.others.validators import (
    validate_linux_username,
    validate_national_code,
    validate_phone_number,
    validate_english_alphabet,
)
...
class LinFortiUsers(AbstractUser):
    ...
    first_name = models.CharField(
        validators=[validate_english_alphabet],
        max_length=150,
    ...
    date_verify = jmodels.jDateTimeField(
    ...
    farsi_first_name = models.CharField(
        max_length=30, verbose_name="نام به فارسی", blank=False
    )
    farsi_last_name = models.CharField(
        max_length=50, verbose_name=" نام خانوادگی به فارسی", blank=False
    )
...
class FortiGateUserGroup(models.Model):
    ...
    fortigate_name = models.CharField(
...
class LogEntry(models.Model):
    ...
    level = models.PositiveSmallIntegerField(
        choices=LOG_LEVELS, default=logging.ERROR, db_index=True, verbose_name="سطح"
    )
